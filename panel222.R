...
panel222 <- function(n_periods, name_period = "month"){
  ...
  df_possibleScenarios2ndVisit <- utils_admissibleScenarios222(n_periods = n_periods, 
                                                           vctr_rep1stLetterCols = vctr_rep1stLetterCols,
                                                           str_blockInitLetter = "A")
  
  vctr_rep2ndLetterCols <- df_possibleScenarios2ndVisit[1,]
  
  block1 <- utils_minimal_block222(n_periods =  n_periods, vctr_rep1stLetterCols = vctr_rep1stLetterCols, 
                             vctr_rep2ndLetterCols = vctr_rep2ndLetterCols,
                             str_blockInitLetter = "A")
  
  if(name_period == "month"){
    block2 <- utils_minimal_block222(n_periods =  n_periods, vctr_rep1stLetterCols = vctr_rep1stLetterCols, 
                               vctr_rep2ndLetterCols = vctr_rep2ndLetterCols,
                               str_blockInitLetter = "E")
    block3 <- utils_minimal_block222(n_periods =  n_periods, vctr_rep1stLetterCols = vctr_rep1stLetterCols, 
                               vctr_rep2ndLetterCols = vctr_rep2ndLetterCols,
