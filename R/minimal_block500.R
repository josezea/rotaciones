...
minimal_block500 <- function(n_periods, vctr_rep1stLetterCols, 
  ...
  out <- cbind(
    row_500(n_periods, vctr_rep1stLetterCols[1], Letters[1]), 
    row_500(n_periods, vctr_rep1stLetterCols[2], Letters[2]),
    row_500(n_periods, vctr_rep1stLetterCols[3], Letters[3]),
    row_500(n_periods, vctr_rep1stLetterCols[4], Letters[4]),
    row_500(n_periods, vctr_rep1stLetterCols[5], Letters[5]))
  out
}
