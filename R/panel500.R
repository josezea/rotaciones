...
panel500 <- function(n_periods, name_period = "month"){
  ...
  block1 <- minimal_block500(n_periods =  n_periods, vctr_rep1stLetterCols = vctr_rep1stLetterCols, 
                             str_blockInitLetter = "A")
  
  if(name_period == "month"){
    block2 <- minimal_block500(n_periods =  n_periods, 
                               vctr_rep1stLetterCols = vctr_rep1stLetterCols, 
                               str_blockInitLetter = "F")
    block3 <- minimal_block500(n_periods =  n_periods, 
                               vctr_rep1stLetterCols = vctr_rep1stLetterCols, 
